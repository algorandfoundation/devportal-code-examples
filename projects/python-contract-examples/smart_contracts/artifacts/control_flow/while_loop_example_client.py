...
class WhileLoopExampleClient:
    """A class for interacting with the WhileLoopExample app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        WhileLoopExampleClient can be created with an app_id to interact with an existing application, alternatively
