...
class GlobalState:
    def __init__(self, data: dict[bytes, bytes | int]):
        self.contact_info = ByteReader(typing.cast(bytes, data.get(b"contact_info")))
...
class Composer:
    ...
    def add_contact_info(
        ...
        *,
        ...
        Adds a call to `add_contact_info((string,string,uint64))uint64` ABI method
        
        :param tuple[str, str, int] contact: The `contact` ABI parameter
...
class Arc4TupleClient:
    ...
    def add_contact_info(
        ...
        *,
        ...
        Calls `add_contact_info((string,string,uint64))uint64` ABI method
