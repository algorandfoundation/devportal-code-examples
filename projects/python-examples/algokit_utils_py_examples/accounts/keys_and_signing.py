...
def keys_and_signing() -> None:
    ...
    algorand_client, _, account1, account2, _ = setup_localnet_environment()
    ...
    """
    signer = algorand_client.account.get_signer(account1.address)

    """
    account1 is a `SigningAccount` that already has a signer.
