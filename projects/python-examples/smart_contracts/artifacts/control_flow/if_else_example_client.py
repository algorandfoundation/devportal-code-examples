...
@dataclasses.dataclass(kw_only=True)
class IsRichArgs(_ArgsBase[str]):
    account_balance: int
...
@dataclasses.dataclass(kw_only=True)
class IsEvenArgs(_ArgsBase[str]):
    number: int
...
class Composer:
    ...
    def is_rich(
        ...
        *,
        ...
        """Adds a call to `is_rich(uint64)string` ABI method
        
        :param int account_balance: The `account_balance` ABI parameter
    ...
    def is_even(
        ...
        *,
        ...
        """Adds a call to `is_even(uint64)string` ABI method
        
        :param int number: The `number` ABI parameter
        :param algokit_utils.TransactionParameters transaction_parameters: (optional) Additional transaction parameters
        :returns Composer: This Composer instance"""
...
class IfElseExampleClient:
    """A class for interacting with the IfElseExample app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        IfElseExampleClient can be created with an app_id to interact with an existing application, alternatively
    ...
    def is_rich(
        ...
        *,
        ...
        """Calls `is_rich(uint64)string` ABI method
    ...
    def is_even(
        ...
        *,
        ...
        """Calls `is_even(uint64)string` ABI method
