...
import { ReferenceAccountAssetFactory } from '@/contracts/artifacts/clients/ReferenceAccountAsset/ReferenceAccountAssetClient'
...
export async function deploy() {
  ...
  const typedFactory = algorand.client.getTypedAppFactory(ReferenceAccountAssetFactory, {
