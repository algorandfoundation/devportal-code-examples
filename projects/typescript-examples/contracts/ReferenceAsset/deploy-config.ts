...
import { ReferenceAssetFactory } from '@/contracts/artifacts/clients/ReferenceAsset/ReferenceAssetClient'
...
export async function deploy() {
  ...
  const typedFactory = algorand.client.getTypedAppFactory(ReferenceAssetFactory, {
