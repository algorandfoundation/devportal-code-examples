...
import { CustomCreateFactory } from '@/contracts/artifacts/clients/CustomCreate/CustomCreateClient'
...
export async function deploy() {
  ...
  const typedFactory = algorand.client.getTypedAppFactory(CustomCreateFactory, {
