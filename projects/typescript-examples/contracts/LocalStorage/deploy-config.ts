...
import { LocalStorageFactory } from '@/contracts/artifacts/clients/LocalStorage/LocalStorageClient'
...
export async function deploy() {
  ...
  const typedFactory = algorand.client.getTypedAppFactory(LocalStorageFactory, {
