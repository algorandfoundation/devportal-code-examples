...
import { ReferenceAccountFactory } from '@/contracts/artifacts/clients/ReferenceAccount/ReferenceAccountClient'
...
export async function deploy() {
  ...
  const typedFactory = algorand.client.getTypedAppFactory(ReferenceAccountFactory, {
