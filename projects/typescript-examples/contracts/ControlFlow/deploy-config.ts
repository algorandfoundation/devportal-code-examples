...
import { ControlFlowFactory } from '@/contracts/artifacts/clients/ControlFlow/ControlFlowClient'
...
export async function deploy() {
  ...
  const typedFactory = algorand.client.getTypedAppFactory(ControlFlowFactory, {
