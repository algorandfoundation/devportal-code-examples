...
import { ReferenceAppFactory } from '@/contracts/artifacts/clients/ReferenceApp/ReferenceAppClient'
...
export async function deploy() {
  ...
  const typedFactory = algorand.client.getTypedAppFactory(ReferenceAppFactory, {
