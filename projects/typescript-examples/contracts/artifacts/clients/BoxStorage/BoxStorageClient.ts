...
export class BoxStorageClient {
  ...
  state = {
    ...
    box: {
      ...
      /**
       * Get values from the boxMapStruct map in box state
       */
      boxMapStruct: {
        /**
         * Get all current values of the boxMapStruct map in box state
         */
        getMap: async (): Promise<Map<bigint, UserStruct>> => { return (await this.appClient.state.box.getMap("boxMapStruct")) as Map<bigint, UserStruct> },
        /**
         * Get a current value of the boxMapStruct map by key from box state
         */
        value: async (key: bigint | number): Promise<UserStruct | undefined> => { return await this.appClient.state.box.getMapValue("boxMapStruct", key) as UserStruct | undefined },
      },
    },
  }
