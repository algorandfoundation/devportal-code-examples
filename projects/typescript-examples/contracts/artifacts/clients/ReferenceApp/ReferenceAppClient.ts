...
export type ReferenceAppArgs = {
  ...
  tuple: {
    ...
    'incrementViaInnerWithArg(application)uint64': [app: bigint]
  }
}
...
export type ReferenceAppReturns = {
  ...
  'incrementViaInnerWithArg(application)uint64': bigint
}
...
export type ReferenceAppTypes = {
  ...
  methods:
    ...
    & Record<'incrementViaInnerWithArg(application)uint64' | 'incrementViaInnerWithArg', {
      argsObj: ReferenceAppArgs['obj']['incrementViaInnerWithArg(application)uint64']
      argsTuple: ReferenceAppArgs['tuple']['incrementViaInnerWithArg(application)uint64']
      /**
       * The incremented counter value from the inner call
       */
      returns: ReferenceAppReturns['incrementViaInnerWithArg(application)uint64']
    }>
}
...
export abstract class ReferenceAppParamsFactory {
  ...
  /**
   * Constructs a no op call for the incrementViaInnerWithArg(application)uint64 ABI method
   *
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static incrementViaInnerWithArg(params: CallParams<ReferenceAppArgs['obj']['incrementViaInnerWithArg(application)uint64'] | ReferenceAppArgs['tuple']['incrementViaInnerWithArg(application)uint64']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'incrementViaInnerWithArg(application)uint64' as const,
...
export class ReferenceAppClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the ReferenceApp smart contract using the `incrementViaInnerWithArg(application)uint64` ABI method.
     *
     * Calls the increment method on another Counter app passed as an argument
     *
     * @param params The params for the smart contract call
     * @returns The call params: The incremented counter value from the inner call
     */
    incrementViaInnerWithArg: (params: CallParams<ReferenceAppArgs['obj']['incrementViaInnerWithArg(application)uint64'] | ReferenceAppArgs['tuple']['incrementViaInnerWithArg(application)uint64']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
  ...
  readonly send = {
     ...
     * @returns The call result: The incremented counter value from the inner call
     */
    incrementViaInnerWithArg: async (params: CallParams<ReferenceAppArgs['obj']['incrementViaInnerWithArg(application)uint64'] | ReferenceAppArgs['tuple']['incrementViaInnerWithArg(application)uint64']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(ReferenceAppParamsFactory.incrementViaInnerWithArg(params))
      return {...result, return: result.return as unknown as (undefined | ReferenceAppReturns['incrementViaInnerWithArg(application)uint64'])}
    },
  ...
  public newGroup(): ReferenceAppComposer {
    ...
    return {
      ...
      /**
       * Add a incrementViaInnerWithArg(application)uint64 method call against the ReferenceApp contract
       */
      incrementViaInnerWithArg(params: CallParams<ReferenceAppArgs['obj']['incrementViaInnerWithArg(application)uint64'] | ReferenceAppArgs['tuple']['incrementViaInnerWithArg(application)uint64']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.incrementViaInnerWithArg(params)))
        resultMappers.push((v) => client.decodeReturnValue('incrementViaInnerWithArg(application)uint64', v))
        return this
      },
      /**
...
export type ReferenceAppComposer<TReturns extends [...any[]] = []> = {
  ...
  /**
   * Calls the incrementViaInnerWithArg(application)uint64 ABI method.
   *
   * Calls the increment method on another Counter app passed as an argument
   *
   * @param args The arguments for the contract call
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  incrementViaInnerWithArg(params?: CallParams<ReferenceAppArgs['obj']['incrementViaInnerWithArg(application)uint64'] | ReferenceAppArgs['tuple']['incrementViaInnerWithArg(application)uint64']>): ReferenceAppComposer<[...TReturns, ReferenceAppReturns['incrementViaInnerWithArg(application)uint64'] | undefined]>
   ...
   */
  simulate(): Promise<ReferenceAppComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<ReferenceAppComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<ReferenceAppComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
