...
export type ReferenceAccountAppComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<ReferenceAccountAppComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<ReferenceAccountAppComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<ReferenceAccountAppComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
