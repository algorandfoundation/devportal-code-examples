...
import { ReferenceAccountAppFactory } from '@/contracts/artifacts/clients/ReferenceAccountApp/ReferenceAccountAppClient'
...
export async function deploy() {
  ...
  const typedFactory = algorand.client.getTypedAppFactory(ReferenceAccountAppFactory, {
