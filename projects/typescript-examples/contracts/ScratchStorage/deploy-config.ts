...
import { ScratchStorageFactory } from '@/contracts/artifacts/clients/ScratchStorage/ScratchStorageClient'
...
export async function deploy() {
  ...
  const typedFactory = algorand.client.getTypedAppFactory(ScratchStorageFactory, {
